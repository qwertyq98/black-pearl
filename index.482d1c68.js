...
var _observer = require("@modules/utils/observer");
var _scrollAmimate = require("@modules/utils/scroll-amimate");
var _scroll = require("@modules/utils/scroll");
var _mobileMenu = require("@modules/utils/mobile-menu");
var _swiper = require("@modules/utils/swiper");
var _popups = require("@modules/popups/popups");
var _test = require("@modules/test/test");
var _products = require("@modules/products/products");

},{"@modules/utils/observer":"4WOt8","@modules/utils/scroll-amimate":"cCzTw","@modules/utils/scroll":"iNonJ","@modules/utils/mobile-menu":"lqJA0","@modules/utils/swiper":"9gZEy","@modules/popups/popups":"gVGGt","@modules/test/test":"lMRB4","@modules/products/products":"5VFQZ"}],"4WOt8":[function(require,module,exports) {
...
},{}],"cCzTw":[function(require,module,exports) {
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (windowWidth < 1000) {
        ...
        const texts = document.querySelectorAll(".element-animation_text");
...
function onEntry(entry) {
    entry.forEach((change)=>{
        if (change.isIntersecting) {
            if (change.target.classList.contains("element-animation_text")) change.target.classList.add("element-show_text");
            else change.target.classList.add("element-show");
        }
    });
}

},{}],"iNonJ":[function(require,module,exports) {
...
},{"smoothscroll-polyfill":"1W2LT","./scroll-lock":"1ADUT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1W2LT":[function(require,module,exports) {
...
},{}],"1ADUT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "lockScroll", ()=>lockScroll);
parcelHelpers.export(exports, "unlockScroll", ()=>unlockScroll);
...
},{}],"lqJA0":[function(require,module,exports) {
var _scrollLock = require("./scroll-lock");
const $body = document.querySelector("body");
const $burgers = document.querySelectorAll(".hamburger");
const $mobileMenus = document.querySelectorAll(".header__wrapper");
const $mobileLinks = document.querySelectorAll(".header__list-item");
...
Array.from($burgers).forEach(($burger)=>$burger.addEventListener("click", ()=>{
        ...
        Array.from($mobileMenus).forEach(($mobileMenu)=>{
            ...
            if ($mobileMenus[0].classList.contains("is-active")) (0, _scrollLock.lockScroll)();
            else (0, _scrollLock.unlockScroll)();
        });
...
},{"./scroll-lock":"1ADUT"}],"9gZEy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "swiper1", ()=>swiper1);
parcelHelpers.export(exports, "swiper2", ()=>swiper2);
parcelHelpers.export(exports, "swiper3", ()=>swiper3);
var _swiper = require("swiper");
var _swiperDefault = parcelHelpers.interopDefault(_swiper);
var _modules = require("swiper/modules");
var _swiperMinCss = require("swiper/swiper.min.css");
var _paginationScss = require("swiper/modules/pagination.scss");
const swiper1 = new (0, _swiperDefault.default)(".swiper1", {
...
const swiper2 = new (0, _swiperDefault.default)(".swiper2", {
    direction: "horizontal",
    modules: [
        (0, _modules.Navigation),
        (0, _modules.Pagination)
...
const swiper3 = new (0, _swiperDefault.default)(".swiper3", {
    direction: "horizontal",
    modules: [
        (0, _modules.Navigation),
        (0, _modules.Pagination)
...
},{"swiper":"iM6UL","swiper/modules":"9ktz6","swiper/swiper.min.css":"eFTGe","swiper/modules/pagination.scss":"47rMB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iM6UL":[function(require,module,exports) {
/**
 * Swiper 10.3.1
...
},{"../shared/create-shadow.mjs":"bWkQq","../shared/effect-init.mjs":"88TTi","../shared/effect-target.mjs":"3jkAD","../shared/effect-virtual-transition-end.mjs":"dzFvU","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eFTGe":[function() {},{}],"47rMB":[function() {},{}],"gVGGt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setOpenPopupHandler", ()=>setOpenPopupHandler);
parcelHelpers.export(exports, "setClosePopupHandler", ()=>setClosePopupHandler);
parcelHelpers.export(exports, "escapeHandler", ()=>escapeHandler);
var _scrollLock = require("../utils/scroll-lock");
let counter = 0;
const popups = document.querySelectorAll(".popup");
const linkPopups = document.body.querySelectorAll("[data-popup-id]");
popups.forEach((popup)=>setClosePopupHandler(popup));
linkPopups.forEach((link)=>setOpenPopupHandler(link));
function setOpenPopupHandler(link) {
    link.addEventListener("click", openPopupHandler);
    function openPopupHandler(event) {
        event.preventDefault();
        if (link.dataset.popupId) openPopup(link.dataset.popupId);
    }
}
function setClosePopupHandler(popup) {
...
function openPopup(popupSelector) {
    ...
    popup.style.backgroundColor = "";
    counter++;
    if (counter === 1) popup.style.backgroundColor = "rgba(0, 0, 0, 0.8)";
    if (popup) {
        (0, _scrollLock.lockScroll)();
...
function escapeHandler(event) {
    if (event.key == "Escape") {
        ...
        (0, _scrollLock.unlockScroll)();
        document.removeEventListener("keydown", escapeHandler);
        if (resultPopup) resultPopup?.closest(".popup")?.remove();
    }
}

},{"../utils/scroll-lock":"1ADUT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lMRB4":[function(require,module,exports) {
var _popups = require("@modules/popups/popups");
var _utils = require("@modules/utils");
var _scrollLock = require("@modules/utils/scroll-lock");
var _data = require("./data");
var _templateTest = require("./template-test");
const answers = [];
let questionNumber = 0;
const createQuizCardsTemplates = (questions)=>questions.map((question)=>(0, _utils.createElement)((0, _templateTest.quizTemplate)(question)));
const createResultTemplates = (result)=>(0, _utils.createElement)((0, _templateTest.resultTemplate)(result));
const quizCardsTemplates = createQuizCardsTemplates((0, _data.DataQuestions));
const startTestButton = document.querySelector(".test__start-btn");
const closeButtons = quizCardsTemplates.map((question)=>question?.querySelector(".popup__close-button"));
...
function showResults() {
    (0, _scrollLock.lockScroll)();
    questionNumber = 0;
    const result = (0, _utils.occurrence)(answers);
    ...
    resultPopup?.querySelector(".popup__close-button")?.addEventListener("click", ()=>{
        answers.length = 0;
        resultPopup?.remove();
        (0, _scrollLock.unlockScroll)();
    });
...
function overlayCloseHandler(event) {
    ...
    if (event.target === currentTarget) {
        ...
        currentTarget.querySelector(".quiz__result-wrapper") && currentTarget?.remove();
    }
}
buttonsContainers.forEach((container)=>{
    container.addEventListener("click", (event)=>{
        const element = event.target.closest(".quiz__answer-wrapper");
        if (element) {
            const elementId = element.dataset.answerId;
            if (elementId) answers.push((0, _data.DataQuestions)[questionNumber].questionAnswers[+elementId].score);
            closeQuestion(quizCardsTemplates[questionNumber]);
            if ((0, _data.DataQuestions).length - 1 > questionNumber) {
                questionNumber++;
...
},{"@modules/popups/popups":"gVGGt","@modules/utils":"caim5","@modules/utils/scroll-lock":"1ADUT","./data":"aUkX6","./template-test":"a9ERx"}],"caim5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createElement", ()=>createElement);
parcelHelpers.export(exports, "occurrence", ()=>occurrence);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aUkX6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const DataQuestions = [
    {
        questionText: "Представьте, что на&nbsp;один день вы&nbsp;вновь стали ребёнком. Чем займётесь в&nbsp;этот зимний день?",
        number: 1,
        questionAnswers: [
            {
    ...
    {
        questionText: "У&nbsp;вас есть 3&nbsp;выходных и&nbsp;неограниченный бюджет. Куда отправитесь?",
        number: 2,
        questionAnswers: [
            {
    ...
    {
        questionText: "Какое у&nbsp;вас самое яркое воспоминание о&nbsp;зиме из&nbsp;детства?",
        number: 5,
        questionAnswers: [
            {
...
const dataResults = [
    {
        image: new URL(require("e38b128c44a76876")),
    ...
    {
        image: new URL(require("253e563558faddb2")),
    ...
    {
        image: new URL(require("29f8d94d33158c09")),
        subtitle: "На горку!",
...
},{"e38b128c44a76876":"gINZg","253e563558faddb2":"4eqrX","29f8d94d33158c09":"e8zyJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gINZg":[function(require,module,exports) {
module.exports = require("749f92ba58faaf6a").getBundleURL("7XnOB") + "res3.ff88be1f.jpeg" + "?" + Date.now();

},{"749f92ba58faaf6a":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"4eqrX":[function(require,module,exports) {
module.exports = require("ef3a87a0cdaffb5f").getBundleURL("7XnOB") + "res2.9f40b1c3.jpeg" + "?" + Date.now();

},{"ef3a87a0cdaffb5f":"lgJ39"}],"e8zyJ":[function(require,module,exports) {
module.exports = require("1b8087b3d3901fe3").getBundleURL("7XnOB") + "res1.b0867496.jpeg" + "?" + Date.now();

},{"1b8087b3d3901fe3":"lgJ39"}],"a9ERx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "quizTemplate", ()=>quizTemplate);
parcelHelpers.export(exports, "resultTemplate", ()=>resultTemplate);
var _data = require("./data");
const renderAnswers = (answers)=>answers.map((answer, index)=>`
      ...
      `).join("");
const generateResult = (count, field)=>{
    if (count === 1) return (0, _data.dataResults)[count][field];
    else if (count === 2) return (0, _data.dataResults)[count][field];
    else return (0, _data.dataResults)[count][field];
};
const quizTemplate = (question)=>{
  ...
  <div class="popup popup__question" id='${question.number}'>
    <div class="popup__container quiz__wrapper">
        ...
        <div class="${question.number === 1 || question.number === 5 ? "quiz__buttons quiz__buttons_row" : "quiz__buttons"}">
  ...
  <div class="popup popup__container popup__question" id='quizPopup'>
    <div class="popup__container quiz__result-wrapper">
        ...
        <div class="quiz__result-content">
            ...
            <h3>Результат</h3>
            <p class="quiz__result-text">${generateResult(count, "subtitle")}</p>
            <p class="quiz__result-description">${generateResult(count, "text")}</p>
            </div>
...
},{"./data":"aUkX6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5VFQZ":[function(require,module,exports) {
const $linksProducts = document.body.querySelectorAll(".products__button");
const $tabsElements = document.body.querySelectorAll(".products__product");
...
function setShowProductHandler(link) {
    ...
    function showTab() {
        $linksProducts.forEach((link)=>link.classList.remove("products__button_active"));
        $tabsElements.forEach((tab)=>tab.classList.remove("products__product_active"));
        link.classList.add("products__button_active");
        document.getElementById(currentButtomName)?.classList.add("products__product_active");
        if (currentButtomName === "spf" || currentButtomName === "busters") $productsSection?.classList.add("products_beige");
        else $productsSection?.classList.remove("products_beige");
    }
}

},{}]},["loNOH","j6eqU"], "j6eqU", "parcelRequire9b17")
